...
class Classifier(nn.Module):
    def __init__(self, hidden_1, hidden_2, dropout_prob):
...
model = Classifier(hidden_1=512, hidden_2=512, dropout_prob=0.2)
print(model)
...
# =============================================================================
        ...
        if valid_loss <= valid_loss_min:
            print('Validation loss decreased ({:.6f} --> {:.6f}). Saving Model ...'.format(
                    valid_loss_min,
                    valid_loss))
            torch.save(model.state_dict(), 'mlp_model_SGD_mnist.pt')
